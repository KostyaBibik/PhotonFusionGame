...
public abstract class InputValueContextBase
{
    ...
    public abstract void RegisterValueChangingCallback(Action callback, EGameSystemType systemType);
}
...
public abstract class InputValueContext<T> : InputValueContextBase where T : struct
{
    ...
    private Dictionary<EGameSystemType, List<Action>> _callbacks = new();
    ...
    public override void RegisterValueChangingCallback(Action callback, EGameSystemType systemType)
    {
